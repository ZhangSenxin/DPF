...
def main():
    ...
    feature_path_use = sequence_path
    save_path_folder = save_path
    st.mkdir(save_path_folder)
    end_line = st.wc_py(sequence_path)
    ...
    for folder in folders:
        ...
        set_seed(seed)
        model_eval = MixtureOfExperts(CSA2, input_dim, hidden_dim, output_dim, num_experts, expert_hidden_dim, output_dim,
                                      dropout=dropout)
